...
public class NetworkException extends RuntimeException {
    ...
    public static NetworkException networkError(IOException exception) {
        return new NetworkException(exception.getMessage(), null, null, Kind.NETWORK, exception, null);
    }
    ...
    NetworkException(String message, String url, Response response, Kind kind, Throwable exception, Retrofit retrofit) {
